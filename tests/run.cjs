...
/* ═══════════ ⑮ ترجيح إصدار ويكيبيديا بالسنة ═══════════ */
G("⑮ اختيار الإصدار الصحيح من ويكيبيديا");
{
  /* بحث ويكيبيديا يرتّب بالشهرة لا بالسنة: «God of War» يعطي إصدار 2018 أولًا،
     فظهر وصف لعبة PS4 على لعبة PS2 لعام 2005 في مكتبة المستخدم — «released
     worldwide for the PlayStation 4 in April 2018». السنة كانت تُستخرَج أصلًا
     من ويكي داتا وتُهمَل عند الاختيار. هذه الدالة الخالصة هي حَكَم الترجيح. */
  ok(C.wikiYearFits(2005, 2005), "السنة نفسها تطابق");
  ok(C.wikiYearFits(2005, 2004), "سنة قبلها تطابق — الإصدار يختلف بين الأسواق");
  ok(C.wikiYearFits(2005, 2006), "وسنة بعدها كذلك");
  ok(!C.wikiYearFits(2018, 2005), "God of War 2018 لا يطابق لعبة 2005 — جوهر الخلل");
  ok(!C.wikiYearFits(2005, 2018), "والعكس كذلك");
  ok(!C.wikiYearFits(0, 2005), "بلا سنة من ويكيبيديا ⇒ لا ترجيح");
  ok(!C.wikiYearFits(2005, 0), "بلا سنة معروفة عندنا ⇒ لا ترجيح");
  ok(!C.wikiYearFits(null, null), "قيم فارغة لا تنهار ولا تُرجّح");
  ok(!C.wikiYearFits("abc", 2005), "سنة غير رقمية لا تُرجّح");
